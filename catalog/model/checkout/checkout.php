...
class ModelCheckoutCheckout extends Model {
	...
	public function createOrder() {
		...
		$order_data = array(
			...
			'fullname'                  => $this->customer->isLogged() ? $this->customer->getFullName() : '',
		...
		if (!$this->customer->isLogged()) {
			$order_data['fullname'] = array_get($this->session->data, 'guest.fullname', '');
		...
		// Example. $this->session->data['payment_address']['fullname'] -> $this->session->data['payment_fullname']
